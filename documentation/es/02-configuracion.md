...
# Instagram API — Broadcast (Laravel Reverb) 🆕 v1.0.80
...
Si planeas usar los eventos broadcast (disponibles desde v1.0.80), asegúrate de tener Laravel Reverb configurado en tu proyecto:
