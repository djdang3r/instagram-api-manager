...
# Instagram API — Broadcast (Laravel Reverb) 🆕 v1.0.79
...
Si planeas usar los eventos broadcast (disponibles desde v1.0.79), asegúrate de tener Laravel Reverb configurado en tu proyecto:
